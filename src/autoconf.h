...
/* Define to 1 if you have the `mvwaddnwstr' function. */
...
/* Define to mark as a release build with extra optimizations. */
/* #undef RELEASE_BUILD */

/* Define if running as a central install on a multiuser system that has
   setresgid or setegid support. */
/* #undef SETGID */
...
/* Define to 1 to build the command-line spoiler generation */
#define USE_SPOIL 1

/* Define to 0 to omit the stats frontend */
/* #undef USE_STATS */

/* Define to 1 to build the test frontend */
/* #undef USE_TEST */

/* Define to 1 if using the Windows interface. */
/* #undef USE_WIN */
...
/* Defined for systems that guard ncurses decls with _XOPEN_SOURCE_EXTENDED */
